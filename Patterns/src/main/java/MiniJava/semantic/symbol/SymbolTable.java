...
public class SymbolTable {
    ...
    public SymbolTable(Memory memory) {
        ...
        keyWords.put("true", new Address(TRUE_VALUE, varType.Bool, TypeAddress.Imidiate));
        keyWords.put("false", new Address(FALSE_VALUE, varType.Bool, TypeAddress.Imidiate));
    }
